...
public class JungleParkTests extends JunglePark {
  ...
  public static boolean test2isCloseMethod() {
    ...
    // Set deer at position(300,200)
    d.setPositionX(300);
    d.setPositionY(200);
    // Set first tiger at position(500,300)
    tiger1.setPositionX(500); // tiger is 200px away from deer
    tiger1.setPositionY(300);
    // Set second tiger at position(300,200)
    tiger2.setPositionX(300); // tiger is 100px away from deer
    tiger2.setPositionY(200);
 
    if (d.isClose(tiger1, 175)) { // bug! isClose() should return false here
      System.out.println("Deer's isClose is returning true when it should return false.");
      passed = false;
    }
    if (!d.isClose(tiger2, 175)) { // bug! isClose() should return true here
      System.out.println("Deer's isClose is returning false when it should return true.");
      passed = false;
    }
  ...
  public static boolean test1DeerScanForThreatMethod() {
    ...
    d.setPositionX(300);
    d.setPositionY(200);
    // Set first tiger at position(350,200)
    t1.setPositionX(350); // tiger is 150px away from deer
    t1.setPositionY(200);
    // Set second tiger at position(350,200)	
    t2.setPositionX(310); // tiger is 10px away from deer
    t2.setPositionY(200);
    
    
    if (d.scanForThreat(175)) { // bug! scanForThreat() should return false here
        System.out.println("tiger's threat is returning true when it should return false.");
        passed = false;
      }
      if (!d.scanForThreat(175)) { // bug! scanForThreat() should return true here
        System.out.println("tiger's threatis returning false when it should return true.");
        passed = false;
      }
  ...
  public static boolean test2DeerScanForThreatMethod() {
    ...
    d.setPositionY(200);
    // Set first tiger at position(350,200)
    t1.setPositionX(205); // tiger is 5px away from deer
    t1.setPositionY(200);
    ...
    if (d.scanForThreat(175)) { // bug! scanForThreat() should return false here
      ...
      if (!d.scanForThreat(175)) { // bug! scanForThreat() should return true here
        System.out.println("tiger's threat is returning false when it should return true.");
        passed = false;
      }
